...
project_name = ("Model_{}-Discontinuous-{}_Epochs-WrongHint_{}-WrongEval_{}"
...
model1 = SimpleModelCase1(U[:, :200], U[:, :200], U[:, :200].T, B_zeros, B_zeros)
model1.to(device)

model2 = SimpleModelCase2(W, W, B_zeros, B_zeros)
model2.to(device)
...
run = wandb.init(
    ...
    project="Discontinuous_PCA_Initialization",
    ...
    config={
        ...
        "model_description": "Discontinuous Non-linearity, Gradient on Initialized Weights",
